...
const pyr = [
    ...
    
    {
      ...
      opciones: [
        ...
        'C) Infocracia, vigilancia digital, cultura de rendimiento, impacto de las redes sociales y resistencia y ética de la atención'
      ],
    ...
    {
      pregunta:"¿Cúales son las 4 fases importantes en el trascurso de la evolución de la tecnología y su orden?",
      opciones: [
        'a) oral, radio, imprenta, digital',
        'b) oral, imprenta, radio, digital',
    ...
    {
      pregunta:"Tipos de investigación creación",
      opciones: [
        'a) Efímera, permanente y procesual',
        'b) permanente y procesual y normativa',
        'C) oral, reductora y procesual'
      ],
